...
| 필드 | 값 |
|---|---:|
| stageId | `stage_goblin_forest_01` |
...
| 스테이지 | stageId | 의도 |
|---|---|---|
| Goblin Forest 1 | `stage_goblin_forest_01` | 쉬운 2웨이브 기본 전투 |
| Goblin Forest 2 | `stage_goblin_forest_02` | Goblin 수량 증가, 빠른 페이싱 |
| Goblin Forest 3 | `stage_goblin_forest_03` | Orc 압박 증가, Crystal pressure 확인 |

## 9. v0.3 UpgradeData

| 업그레이드 | effectKey | 값 |
|---|---|---:|
| Crystal Reinforcement | `crystal_max_hp_flat` | +20 per level |
| Hero Training | `hero_attack_percent` | +0.05 per level |
| Battle Rhythm | `hero_attack_speed_percent` | +0.03 per level |
| Skill Practice | `skill_cooldown_percent` | +0.03 per level |
